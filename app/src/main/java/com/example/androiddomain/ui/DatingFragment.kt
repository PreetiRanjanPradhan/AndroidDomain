...
import com.example.androiddomain.adapter.DatingAdapter
import com.example.androiddomain.databinding.ActivityMainBinding
import com.example.androiddomain.databinding.FragmentDatingBinding
...
class DatingFragment : Fragment() {
    ...
    private fun init() {
        manager = CardStackLayoutManager(requireContext(),object : CardStackListener{
            override fun onCardDragging(direction: Path.Direction?, ratio: Float) {

            }

            override fun onCardSwiped(direction: Path.Direction?) {
    ...
    private fun getData() {
        val addValueEventListener = FirebaseDatabase.getInstance().getReference("users")
